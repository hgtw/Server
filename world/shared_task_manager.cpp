...
void SharedTaskManager::AttemptSharedTaskCreation(uint32 requested_task_id, uint32 requested_character_id, uint32 npc_type_id)
{
...
void SharedTaskManager::SendAcceptNewSharedTaskPacket(uint32 character_id, uint32 task_id, uint32 npc_type_id)
{
	auto p = std::make_unique<ServerPacket>(
	...
	d->requested_npc_type_id  = npc_type_id;
